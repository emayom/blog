...
- #98 — 포스트 상단 썸네일 렌더링
- #100 — 푸터 리디자인 (프로필 + 네비게이션 그리드 + hover underline)
- #101 — MDX 본문 타이포그래피 반응형 조정
- #102 — MDX 컴포넌트 개선 (인라인 코드 · 외부 링크 아이콘 · 이미지 캡션 · Callout info)
- #103 — blockquote → Callout 마이그레이션
