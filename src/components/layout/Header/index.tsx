...
export const Header = () => {
  ...
  // const logo = `https://readme-typing-svg.herokuapp.com?font=Fugaz+One&size=24&duration=2500&pause=30000&color=${
  //   isDark ? "F8F8F2" : "3C3C43"
  // }&center=true&vCenter=true&random=false&width=110&height=26&lines=emayom`;
