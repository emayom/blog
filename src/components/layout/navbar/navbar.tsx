...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-hairline bg-canvas/72 backdrop-blur-[20px] backdrop-saturate-[180%] dark:border-fg-muted dark:bg-surface-tile-1/72">
