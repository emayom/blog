...
const linkClass
  = 'relative inline-block py-0.5 text-fg-subtle transition-colors hover:text-fg after:content-[\'\'] after:absolute after:bottom-0 after:left-0 after:h-px after:w-full after:origin-left after:scale-x-0 after:bg-current after:transition-transform after:duration-200 after:ease-out hover:after:scale-x-100'

const columnTitleClass = 'pb-4 text-fg'
const mutedClass = 'text-fg-subtle'
  ...
  return (
    <footer className="border-t border-hairline bg-canvas-parchment py-16">
      <div className="mx-auto max-w-4xl px-6">
        ...
        {/* 하단 바 */}
        <div className={`mt-12 flex flex-col gap-1 border-t border-hairline pt-6 sm:flex-row sm:justify-between ${mutedClass}`}>
