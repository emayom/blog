---
title: "Context API는 상태 관리 도구인가?"
date: "2024-03-13"
tags: ["react"]
draft: false
featured: true
description: "Context API가 상태 관리 도구인지 살펴보고, Prop Drilling 해결을 위한 의존성 주입 도구로서의 역할과 사용 시 고려사항을 정리합니다."
thumbnail: "/images/fp-a2b8.webp"
---

# Context API는 "상태 관리" 도구인가?
[이전 글](/blog/data-flow-in-react)에서는 리액트의 특징 중 하나인 단방향 데이터 흐름에 대해 언급했습니다.  
