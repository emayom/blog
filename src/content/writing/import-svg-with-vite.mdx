---
title: "Vite + TypeScript 환경에서 SVGR 사용하기: SVG-in-JS"
date: "2024-01-21"
tags: ["react", "tooling"]
draft: false
description: "Vite 환경에서 SVG를 리액트 컴포넌트로 사용하는 방법과 SVG 사용 방식별 트레이드오프를 정리합니다."
thumbnail: ""
---
...
<Callout type="tip">
  Perf tips: `loading="lazy"`와 같은 속성을 사용하여 지연 로딩을 설정하거나 `importance="high"`와 같은 속성을 사용하여 fetch 우선 순위를 조정할 수 있다.
</Callout>
